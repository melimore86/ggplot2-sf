...
Example using two maps side by side, including the legend of the first one. Illustrates how to use a custom grid, which can be made a lot more complex with different elements.
...
Explain how this can be used to plot any ggplot objects together on a predefined grid (see https://cran.r-project.org/web/packages/cowplot/vignettes/introduction.html and https://cran.r-project.org/web/packages/cowplot/vignettes/plot_grid.html)
