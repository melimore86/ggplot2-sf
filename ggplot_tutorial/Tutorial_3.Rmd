...
Using viewports (note: initial viewport takes the entire plot, from 0 to 1 on both axes):
...
Alaska (note: `datum = NA` removes graticules):
...
galaska <- ggplotGrob(alskaggplot(data = usa) +
    geom_sf(fill = "cornsilk") +
    coord_sf(crs = st_crs(3467), xlim = c(-2400000, 1500000), ylim = c(1e+05, 
        2500000), expand = FALSE, datum = NA))
