...
Maps are used in a variety of fields to express data in an appealing and interpretive way. Data can be expressed into complex patterns, 
...
geocodeQueryCheck()
# hack to try to minimize chances of getting rejected by Google…
